        ...
        switch (tipo) {
            ...
            case "text":
                return "<br/> <div class=form-group" + ">"
                        + " <label for=" + this.id + ">" + this.label + "</label>"
                        + " <input type=" + tipo + " id=" + this.id + " class=\"form-control\" placeholder=\"" + this.dica  + "\" pattern=\"" +this.pattern+ "\"  />"
                        + "</div>";
            case "number":
                return "<br/> <div class=\"form-group\" " + ">"
                        + " <label for=" + this.id + ">" + this.label + "</label>"
                        + " <input type=" + tipo + " id=" + this.id + " placeholder=\" " + this.dica + " \" />"
                        + "</div>";
            case "date":
                return "<br/> <div class=\"form-group\" " + ">"
                        + " <label for=" + this.id + ">" + this.label + "</label>"
                        + " <input class=\"form-control\" type=" + tipo + " id=" + this.id + " pattern= \"[0-9]{4}-[0-9]{2}-[0-9]{2}\"  placeholder=" + this.dica + " />"
                        + "</div>";
            case "radio":
                return "<div class=\"form-group\" " + ">"
                        + " <input class=\"form-check-input\" type=" + tipo + " id=" + this.id + " />"
                        + "</div>";
            case "checkbox":
                return "<div class= \"form-group\" " + ">"
                        + " <input class=\"form-check-input\" type=" + tipo + " id=" + this.id + " placeholder= \"" + this.dica + " \" />"
                        + "</div>";
            case "textarea":
                return "<br/> <div class=\"form-group\" " + ">"
                        + " <label for=" + this.id + ">" + this.label + "</label>"
                        + " <input class=\"form-control \" type=" + tipo + " id=" + this.id + " placeholder=\"" + this.dica + "\" rows=3 " + " />"
                        + "</div>";
            case "endereco":
                return endereco();
